...
public class TableGenerator : MonoBehaviour
{
    ...
    [Header("Leg Size")]
    [Range(0.01f, 1f)]
    public float legWidth = 0.075f;
    [Range(0.01f, 1f)]
    public float legHeight = 0.65f;
    [Range(0.01f, 1f)]
    public float legDepth = 0.075f;
    ...
    public void Generate()
    {
        ...
        CombineInstance[] combinedMesh = new CombineInstance[5];
