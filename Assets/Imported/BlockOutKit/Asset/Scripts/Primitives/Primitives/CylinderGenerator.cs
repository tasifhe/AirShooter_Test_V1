...
public class CylinderGenerator : MonoBehaviour
{
    ...
    {
        GetComponent<MeshFilter>().mesh = CylinderGenerate(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength, flatShading);
    }
